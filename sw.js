...
const CORE = [
  ...
  'assets/css/fonts.css', 'assets/css/motion.css',
  'assets/js/store.js', 'assets/js/site.js', 'assets/js/sync.js',
  'assets/img/logo.jpg',
  /* Self-hosted faces: without these an offline visitor falls back to a system
     font and the whole page reflows. */
  'assets/fonts/inter-400-latin.woff2',
  'assets/fonts/inter-700-latin.woff2',
  'assets/fonts/source-serif-4-700-latin.woff2'
];
