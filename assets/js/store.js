...
function seedDB(){
  ...
  const db = {
    ...
    news: [],
    starsOfWeek: {staff:{name:"Uncle Ebenezer",role:"Primary 3 Class Teacher",week:"Week of Sept 15, 2026"},pupil:{name:"Adaeze Okonkwo",class:"Primary 4",week:"Week of Sept 15, 2026"}},
