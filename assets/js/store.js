...
function seedDB(){
  ...
  const db = {
    ...
    newsEvents: [
      {id:"NEG1", type:"event", historic:true, title:"1st Graduation Ceremony", date:"2017-07-26", image:"assets/img/graduates/grad-01.jpg", videoUrl:"", views:0, likes:0, images:[], text:"The very first graduation in our history — 6 pupils who joined us from other private and public schools graduated with flying colours. — led by their Head Girl and Head Boy.", story:"The first graduation ceremony of Treasure Academy, Ageva, took place on Wednesday, 26th July, 2017.\n\nThe graduands were 6 pupils in number — children from other private and public schools who joined the school between 2016 and 2017 — and they successfully graduated with flying colours. To God be the glory!\n\nThe graduands — the first set of graduates Treasure Academy ever celebrated — were:\n1. Jimoh Faridat — Head Girl\n2. Aliyu AbdulHakeem\n3. Olowolabi Favour\n4. Abdulrazak Kamirudeen\n5. Rashidat Muhammed\n6. MomohJimoh Mutolib — Head Boy\n\nBefore this set, one pupil — the school's very first graduate — had already completed the school alone in 2016. It was this 2017 set that the school first celebrated with a full graduation ceremony.\n\nA brief history of our school\n\nTreasure Academy, Ageva, was established in 2016 by the Proprietress, Mrs. Shaibu Sidikat Ruth. The school is located in Ageva, Okene Local Government Area of Kogi State, and serves Ageva and the neighbouring communities — a catchment area that keeps growing as the school grows.\n\nThe aim of the school is to build an effective and efficient future leader: raising confident, brilliant and well-mannered children through strong academics and sound morals.\n\nFrom our first pioneer pupils to the strong school family we are today, every graduation ceremony stands on the foundation laid in this first one. To God be the glory.\n\nFor admissions and enquiries, call or WhatsApp the school on 0906 393 2487."},
      {id:"NEG2", type:"event", historic:true, title:"2nd Graduation Ceremony", date:"2018-07-24", image:"assets/img/graduates/grad-02.jpg", videoUrl:"", views:0, likes:0, images:[], text:"Our second graduation at the school premises — another set of graduands from private and public schools, and success in their Common Entrance exams.", story:"The 2nd Graduation Ceremony took place at the school premises on Tuesday, 24th July, 2018 — and it was another big success for the school.\n\nJust like the set before them, the graduands included children who joined Treasure Academy from other private and public schools, and the school continued to grow from strength to strength.\n\nWe are grateful to God for the pupils' success in their Common Entrance and other terminal examinations. The school saw to it that these pupils were registered, as a registered school, for their Common Entrance and other external examinations — a preparation that built their self-determination and their confidence for the exams.\n\nCongratulations to our graduands — once a Treasure pupil, always a Treasure pupil!"},
      {id:"NEG3", type:"event", historic:true, title:"3rd Graduation Ceremony", date:"2019-08-06", image:"assets/img/graduates/grad-03.jpg", videoUrl:"", views:0, likes:0, images:[], text:"The graduands wrote their Common Entrance and other external exams at St. Paul Primary School — and came out victoriously.", story:"The 3rd Graduation Ceremony took place at the school premises on Tuesday, 6th August, 2019.\n\nThe graduands wrote their Common Entrance and other external examinations at St. Paul Primary School, and they came out victoriously in all of them. They made this school proud, and their results were a true testimony of self-determination.\n\nThe school also continued to press towards its own registration for Common Entrance and other external examinations, so that future sets would sit their exams with even greater ease.\n\nWell done, graduands — the school is proud of you!"},
      {id:"NEG4", type:"event", historic:true, title:"4th Graduation Ceremony", date:"2020-08-07", image:"assets/img/graduates/grad-04.jpg", videoUrl:"", views:0, likes:0, images:[], text:"Covid-19 would not stop us — our 11 graduands were called back for a combined graduation and prize-giving ceremony.", story:"The 4th Graduation Ceremony could not hold as usual because of the Covid-19 outbreak.\n\nThe graduands, numbering up to 11 pupils, were asked to come back for a ceremony that combined their graduation with the speech and prize-giving day — so that even in such a difficult year, their hard work would still be celebrated as it deserved.\n\nWe thank God for seeing the school, its pupils and their families through that season, and for the love that kept the Treasure family strong.\n\nTo every graduand of the class of 2020: you overcame a year most pupils never had to face, and you graduated all the same. Well done!"},
      {id:"NEG5", type:"event", historic:true, title:"5th Graduation Ceremony", date:"2021-08-12", image:"assets/img/graduates/grad-05.jpg", videoUrl:"", views:0, likes:0, images:[], text:"After the pandemic, our graduands wrote Common Entrance in our own name and at our own centre — the school now a government-registered exam centre.", story:"The 5th Graduation Ceremony held on Thursday, 12th August, 2021, after the Covid-19 pandemic.\n\nThe graduands wrote their Common Entrance and other examinations in the name of the school — Treasure Academy, Ageva — at the school's own Common Entrance centre. This means the school had been successfully registered by the concerned government authority as a centre certified for Common Entrance examinations. To God be the glory!\n\nFrom sitting external examinations at other centres to conducting them in our own name and at our own centre — this was a milestone for the whole Treasure family.\n\nCongratulations to our graduands, and to every teacher and parent whose hard work made it possible. See more graduation photos on our Alumni & Graduates page."}
    ],
...
const DB = {
  ...
  nextReceipt(){
    ...
    /* 25 September 2026 - the owner supplied the real graduation records
       ...
       publishes itself through the portal (NE9 onward) is never touched. */
    if(!db.realNewsV1){
      db.newsEvents=(db.newsEvents||[]).filter(function(n){return !/^NE[1-8]$/.test(n.id||"");});
      (seedDB().newsEvents||[]).forEach(function(f){ if(!db.newsEvents.some(function(n){return n.id===f.id;})) db.newsEvents.push(f); });
      if(db.comments) Object.keys(db.comments).forEach(function(k){ if(/^NE[1-8]$/.test(k)) delete db.comments[k]; });
      db.realNewsV1=1;
    }
